...
void Recent_UnitTest()
{
    ...
    Recent_Add(pRecent, "A");
    assert(strcmp(pRecent->ppsz[0], "A") == 0);
    assert(pRecent->ppsz[1] == NULL);
    assert(pRecent->ppsz[2] == NULL);
    Recent_Add(pRecent, "B");
    assert(strcmp(pRecent->ppsz[0], "B") == 0);
    assert(strcmp(pRecent->ppsz[1], "A") == 0);
    assert(pRecent->ppsz[2] == NULL);
    Recent_Add(pRecent, "C");
    assert(strcmp(pRecent->ppsz[0], "C") == 0);
    assert(strcmp(pRecent->ppsz[1], "B") == 0);
    assert(strcmp(pRecent->ppsz[2], "A") == 0);
    Recent_Remove(pRecent, "B");
    assert(strcmp(pRecent->ppsz[0], "C") == 0);
    assert(strcmp(pRecent->ppsz[1], "A") == 0);
    assert(strcmp(pRecent->ppsz[2], "B") == 0);
    Recent_Remove(pRecent, "C");
    assert(strcmp(pRecent->ppsz[0], "A") == 0);
    assert(strcmp(pRecent->ppsz[1], "B") == 0);
    assert(strcmp(pRecent->ppsz[2], "C") == 0);
    Recent_Remove(pRecent, "A");
